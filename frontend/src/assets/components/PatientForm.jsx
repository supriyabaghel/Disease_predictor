    ...
    return (
      <div className="my-5 flex flex-col justify-center">
        <div className="flex justify-center">
          <h2 className="m-2 heading p-6 w-4/5 text-3xl text-gray-800 text-center">
        ...
        <Container>
          <form onSubmit={handleFormSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <FormControl fullWidth>
                  <InputLabel id="alcohol-label" required>
                    Alcohol Consumption
                  </InputLabel>
                  <Select
                    required
              ...
              <Grid item xs={6}>
                <FormControl fullWidth>
                  <InputLabel id="smoke-label" required>
                    Smoking Consumption
                  </InputLabel>
                  <Select
                    name="smoke_cons"
            ...
            {/* Submit Button */}
            <div className="buttonContainer mt-5 w-full flex justify-center">
              <Button
                type="submit"
                variant="outlined"
                color="primary"
